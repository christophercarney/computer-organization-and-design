...
##IO_L7P_T1_34
set_property PACKAGE_PIN Y16 [get_ports {buttons[2]}]
...
#IO_L23N_T3_35
set_property PACKAGE_PIN M15 [get_ports {state[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {state[0]}]

#IO_0_35
set_property PACKAGE_PIN G14 [get_ports {state[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {state[1]}]

#IO_L3N_T0_DQS_AD1N_35
set_property PACKAGE_PIN D18 [get_ports {state[2]}]
